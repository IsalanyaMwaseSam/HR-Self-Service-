...
-- CreateEnum
CREATE TYPE "FileCategory" AS ENUM ('COVER_LETTER', 'RESUME', 'OTHER');
...
-- CreateIndex
CREATE UNIQUE INDEX "Education_applicantID_title_key" ON "Education"("applicantID", "title");

-- CreateIndex
CREATE UNIQUE INDEX "Certificate_applicantID_certificateName_key" ON "Certificate"("applicantID", "certificateName");

-- CreateIndex
CREATE UNIQUE INDEX "Experience_applicantID_employerName_startDate_key" ON "Experience"("applicantID", "employerName", "startDate");

-- CreateIndex
CREATE UNIQUE INDEX "Skill_applicantID_skillDescription_key" ON "Skill"("applicantID", "skillDescription");

-- CreateIndex
CREATE UNIQUE INDEX "Language_applicantID_languageName_key" ON "Language"("applicantID", "languageName");
