...
-- DropForeignKey
ALTER TABLE `option` DROP FOREIGN KEY `Option_criterionId_fkey`;
...
-- AddForeignKey
ALTER TABLE `Option` ADD CONSTRAINT `Option_id_fkey` FOREIGN KEY (`id`) REFERENCES `Criterion`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
